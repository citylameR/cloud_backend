...
from cloud_backend.services.rabbit.dependencies import get_rmq_channel_pool
from cloud_backend.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from cloud_backend.services.redis.dependency import get_redis_pool
from cloud_backend.web.application import get_app
